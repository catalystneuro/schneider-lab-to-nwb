...
def fix_openephys_xml_file(file_path: Union[str, Path], overwrite: bool = True, verbose: bool = False):
    """
...
def main():
    ...
    fix_openephys_xml_file(file_path=args.file_path, overwrite=args.overwrite, verbose=args.verbose)
